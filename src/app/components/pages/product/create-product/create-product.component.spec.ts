...
import { SimpleSelectComponent } from '../../../../shared/molecules/simple-select/simple-select.component';
import { MultiSelectComponent } from '../../../../shared/molecules/multi-select/multi-select.component';
...
describe('CreateProductComponent', () => {
  ...
  test('should log error on failed getBrands', () => {
    ...
    (stockServiceMock.getBrands as jest.Mock).mockReturnValueOnce(throwError(() => mockError ));
  ...
  test('should log error on failed getCategories', () => {
    ...
    (stockServiceMock.getCategories as jest.Mock).mockReturnValueOnce(throwError(() => mockError));
  ...
  test('should log error on failed create product',fakeAsync( () => { 
    const mockError = { status: 0 };
    (stockServiceMock.createProduct as jest.Mock).mockReturnValueOnce(throwError(() => mockError ));
    component.formProduct.setValue({
      name: 'Product1a',
      description: 'Description1',
      amount: '10',
