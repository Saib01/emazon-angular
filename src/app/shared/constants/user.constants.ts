...
export const LOGIN_TITTLE_ERROR='Login failed';
export const LOGIN_ERROR='Invalid Credentials, please check your username or password.';


export const USER_TITTLE_ERROR='The user could not be created.';
export const USER_TITTLE_SUCCESSFULLY='The user has been successfully created';